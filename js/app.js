...
function multiply(a, b) { //eslint-disable-line
  let myMutiply = a * b;
  let myStr2 = `The product of ${a} and ${b} is ${myMutiply}.`;
  return [myMutiply, myStr2];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let myStr4 = `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${sumArr} is their sum.`;
  return [sumArr, myStr4];
}
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. T
o do multiplication, use your multiply() function that you've already created. 
...
function multiplyArray(multArr) { //eslint-disable-line
  multArr = multiply(testArray[0], multiply(testArray[1], testArray[2])[0])[0];
  let myStr5 = `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${multArr}.`;
  return [multArr, myStr5];
